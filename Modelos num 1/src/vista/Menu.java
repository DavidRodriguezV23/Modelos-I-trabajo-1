...
public class Menu extends JFrame {
	...
	//Metodo donde se llama a definir el auto y se muestra el jdialog
	public void verAuto(int caso) {
		auto=Liskov.crearAutomovil(caso);
		if(auto!=null) {
			detalles.setVisible(true);
			detalles.anadirInfo(auto);
			detalles.lblImagen.setIcon(new ImageIcon(DetallesAuto.class.getResource("/recursos/"+auto.nombre+".jpg")));
		}
	}
	...
	public Menu() {
		...
		btnSparkgt.setBounds(35, 192, 113, 46);
		...
		btnRenault.setBounds(158, 192, 113, 46);
		contentPane.add(btnRenault);
		
		JButton btnNissan = new JButton("");
		btnNissan.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				verAuto(3);
			}
		});
		btnNissan.setBorderPainted(false);
		btnNissan.setContentAreaFilled(false);
		btnNissan.setFocusable(false);
		btnNissan.setFocusPainted(false);
		btnNissan.setRequestFocusEnabled(false);
		btnNissan.setIcon(new ImageIcon(Menu.class.getResource("/recursos/nissan.png")));
		btnNissan.setBounds(281, 192, 125, 46);
		...
		lblParaLaRealización.setHorizontalAlignment(JLabel.CENTER);
		lblParaLaRealización.setVerticalAlignment(JLabel.CENTER);
